...
(4, '2024-10-20', 'In Progress', 1, 1001, 2, 'Awaiting interview schedule'),
(5, '2024-10-18', 'Rejected', 2, 1002, 3, 'Candidate did not meet role requirements'),
(6, '2024-10-25', 'Accepted', 1, 1003, 1, 'Offer pending visa sponsorship confirmation'),
(7, '2024-11-01', 'In Progress', 2, 1004, 2, 'Candidate is a strong match for the role'),
(8, '2024-11-10', 'Rejected', 3, 1001, 3, 'Application not selected for the next round'),
(9, '2024-11-12', 'In Progress', 2, 1002, 1, 'Interview scheduled for next week'),
(10, '2024-11-14', 'In Progress', 1, 1004, 3, 'Waiting for additional documentation from the candidate'),
(11, '2024-10-05', 'In Progress', 2, 1001, 1, 'Resume submitted and under review'),
(12, '2024-10-06', 'Rejected', 3, 1002, 3, 'Candidate lacks relevant experience'),
(13, '2024-10-10', 'Accepted', 1, 1003, 2, 'Role aligned with candidate skills'),
(14, '2024-10-11', 'In Progress', 2, 1004, 1, 'Preliminary screening passed'),
(15, '2024-10-12', 'Rejected', 3, 1001, 3, 'Position filled by another applicant'),
(16, '2024-10-15', 'In Progress', 1, 1002, 2, 'Application awaiting hiring manager review'),
(17, '2024-10-20', 'Accepted', 2, 1003, 1, 'Offer extended pending confirmation'),
(18, '2024-10-21', 'Rejected', 3, 1004, 3, 'Candidate declined to proceed'),
(19, '2024-10-22', 'In Progress', 1, 1001, 1, 'Pending feedback from recruiter'),
(20, '2024-10-25', 'Accepted', 2, 1002, 2, 'Offer accepted, onboarding in process'),
(21, '2024-10-26', 'In Progress', 3, 1003, 3, 'Awaiting further instructions'),
(22, '2024-10-28', 'Rejected', 1, 1004, 2, 'Position no longer available'),
(23, '2024-10-30', 'Accepted', 2, 1001, 1, 'Candidate successfully onboarded'),
(24, '2024-10-31', 'In Progress', 3, 1002, 3, 'Awaiting decision from hiring manager'),
(25, '2024-11-01', 'Rejected', 1, 1003, 2, 'Candidate not shortlisted for the next round'),
(26, '2024-11-02', 'In Progress', 2, 1004, 3, 'Pending feedback from hiring manager'),
(27, '2024-11-03', 'Rejected', 3, 1001, 1, 'Candidate profile not aligned with role requirements'),
(28, '2024-11-04', 'Accepted', 2, 1002, 2, 'Offer extended and accepted'),
(29, '2024-11-05', 'In Progress', 1, 1003, 3, 'Additional documentation requested'),
(30, '2024-11-06', 'Rejected', 2, 1004, 1, 'Candidate withdrew application'),
(31, '2024-11-07', 'Accepted', 3, 1001, 2, 'Candidate successfully completed onboarding'),
(32, '2024-11-08', 'Rejected', 1, 1002, 3, 'Position filled by another applicant'),
(33, '2024-11-09', 'In Progress', 2, 1003, 1, 'Awaiting interview feedback'),
(34, '2024-11-10', 'Accepted', 3, 1004, 2, 'Offer extended pending candidate confirmation'),
(35, '2024-11-11', 'Rejected', 1, 1001, 3, 'Candidate withdrew from the hiring process'),
(36, '2024-11-12', 'In Progress', 2, 1002, 1, 'Interview rescheduled for a later date'),
(37, '2024-11-13', 'Accepted', 3, 1003, 2, 'Offer extended and onboarding in progress'),
(38, '2024-11-14', 'Rejected', 1, 1004, 3, 'Position filled before interview process'),
(39, '2024-11-15', 'In Progress', 2, 1001, 2, 'Additional screening required'),
(40, '2024-11-16', 'Accepted', 3, 1002, 1, 'Candidate cleared background verification'),
(41, '2024-11-17', 'Rejected', 1, 1003, 3, 'Candidate declined interview invitation'),
(42, '2024-11-18', 'In Progress', 2, 1004, 2, 'Awaiting feedback from hiring manager'),
(43, '2024-11-19', 'Accepted', 3, 1001, 1, 'Offer accepted, onboarding in process'),
(44, '2024-11-20', 'Rejected', 1, 1002, 3, 'Candidate not a match for job role'),
(45, '2024-11-21', 'In Progress', 2, 1003, 2, 'Pending interview outcome'),
(46, '2024-11-22', 'Accepted', 3, 1004, 3, 'Offer extended pending visa confirmation'),
(47, '2024-11-23', 'Rejected', 1, 1001, 2, 'Candidate did not meet job requirements'),
(48, '2024-11-24', 'In Progress', 2, 1002, 1, 'Interview scheduled for next week'),
(49, '2024-11-25', 'Accepted', 3, 1003, 3, 'Role offered and accepted'),
(50, '2024-11-26', 'Rejected', 1, 1004, 2, 'Candidate withdrew from hiring process'),
...
(54, '2024-11-04', 'In Progress', 1, 1008, 2, 'Resume under review, initial feedback positive'),
(55, '2024-11-05', 'Rejected', 2, 1009, 1, 'Application not shortlisted for next round'),
(56, '2024-11-06', 'Accepted', 3, 1010, 2, 'Offer extended and candidate accepted'),
(57, '2024-11-07', 'In Progress', 1, 1011, 3, 'Pending additional documents from the candidate'),
(58, '2024-11-08', 'Rejected', 2, 1012, 1, 'Position filled by another applicant'),
(59, '2024-11-09', 'Accepted', 3, 1013, 2, 'Candidate cleared all interview rounds'),
(60, '2024-11-10', 'In Progress', 1, 1014, 3, 'Awaiting final decision from the recruiter'),
(61, '2024-11-11', 'Rejected', 2, 1015, 1, 'Application withdrawn by candidate'),
(62, '2024-11-12', 'Accepted', 3, 1016, 2, 'Candidate successfully onboarded'),
(63, '2024-11-13', 'In Progress', 1, 1017, 3, 'Initial interview completed, awaiting feedback'),
(64, '2024-11-14', 'Rejected', 2, 1018, 1, 'Application not aligned with job role'),
(65, '2024-11-15', 'Accepted', 3, 1019, 2, 'Offer extended pending candidate confirmation'),
(66, '2024-11-16', 'In Progress', 1, 1020, 3, 'Strong candidate, pending hiring manager feedback'),
(67, '2024-11-17', 'Rejected', 2, 1021, 1, 'Candidate did not pass technical screening'),
(68, '2024-11-18', 'Accepted', 3, 1022, 2, 'Successful application, onboarding scheduled'),
(69, '2024-11-19', 'In Progress', 1, 1023, 3, 'Awaiting further updates from hiring manager'),
(70, '2024-11-20', 'Rejected', 2, 1024, 1, 'Application reviewed but not shortlisted'),
(71, '2024-11-21', 'Accepted', 3, 1025, 2, 'Offer extended, role aligned with candidate skills'),
(72, '2024-11-22', 'In Progress', 1, 1026, 3, 'Initial screening cleared, next round scheduled'),
(73, '2024-11-23', 'Rejected', 2, 1027, 1, 'Position filled before application review'),
(74, '2024-11-24', 'Accepted', 3, 1028, 2, 'Candidate successfully onboarded'),
(75, '2024-11-25', 'In Progress', 1, 1029, 3, 'Awaiting final decision from hiring team'),
(76, '2024-11-26', 'Rejected', 2, 1030, 1, 'Application not shortlisted due to lack of experience'),
(77, '2024-11-27', 'Accepted', 3, 1031, 2, 'Offer extended pending candidate confirmation'),
(78, '2024-11-28', 'In Progress', 1, 1032, 3, 'Pending hiring manager approval'),
(79, '2024-11-29', 'Rejected', 2, 1033, 1, 'Application not aligned with job description'),
(80, '2024-11-30', 'Accepted', 3, 1034, 2, 'Successful application, visa sponsorship confirmed'),
(81, '2024-12-01', 'In Progress', 1, 1035, 3, 'Awaiting additional information from candidate'),
(82, '2024-12-02', 'Rejected', 2, 1036, 1, 'Position filled by internal candidate'),
(83, '2024-12-03', 'Accepted', 3, 1037, 2, 'Candidate cleared all rounds, onboarding scheduled'),
(84, '2024-12-04', 'In Progress', 1, 1038, 3, 'Initial interview completed, awaiting final feedback'),
(85, '2024-12-05', 'Rejected', 2, 1039, 1, 'Application withdrawn by candidate'),
(86, '2024-12-06', 'Accepted', 3, 1040, 2, 'Offer extended, visa sponsorship in process'),
(87, '2024-12-07', 'In Progress', 1, 1041, 3, 'Resume under review, initial feedback positive'),
(88, '2024-12-08', 'Rejected', 2, 1042, 1, 'Application not aligned with hiring requirements'),
(89, '2024-12-09', 'Accepted', 3, 1043, 2, 'Successful application, onboarding scheduled'),
(90, '2024-12-10', 'In Progress', 1, 1044, 3, 'Awaiting final decision from recruiter'),
...
(94, '2024-12-14', 'Rejected', 2, 1048, 1, 'Position filled by another applicant'),
(95, '2024-12-15', 'Accepted', 3, 1049, 2, 'Offer extended, visa requirements met'),
(96, '2024-12-16', 'In Progress', 1, 1050, 3, 'Strong candidate, awaiting final interview feedback');
